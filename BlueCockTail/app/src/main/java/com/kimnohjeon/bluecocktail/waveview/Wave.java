package com.kimnohjeon.bluecocktail.waveview;
...
import com.kimnohjeon.bluecocktail.R;


// y=Asin(ωx+φ)+k
class Wave extends View {
    private final int WAVE_HEIGHT_LARGE = 16*5;
    private final int WAVE_HEIGHT_MIDDLE = 8*5;
    private final int WAVE_HEIGHT_LITTLE = 5*5;
